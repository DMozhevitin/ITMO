...
happyExpList = Happy_Data_Array.listArray (0,34) ([6400,3200,288,64,0,200,0,50,16384,16386,8198,3,2,25600,0,0,256,0,0
	])

{-# NOINLINE happyExpListPerState #-}
happyExpListPerState st =
    token_strs_expected
  where token_strs = ["error","%dummy","%start_parse","Expr","Disj","Conj","Neg","\"->\"","'!'","'&'","'|'","var","'('","')'","%eof"]
        bit_start = st * 15
        bit_end = (st + 1) * 15
