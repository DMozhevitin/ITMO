...
public class FrontServlet extends HttpServlet {
    ...
    private void process(Route route,
        ...
        Method after = findMethod("after", pageClass);
        ...
        try {
            ...
            if (paramTypes.length == 1) {
                ...
                } else if (HttpServletRequest.class.equals(paramTypes[0])) {
                    method.invoke(page, request);
                }
            } else if (paramTypes.length == 2) {
                if (Map.class.equals(paramTypes[0]) && HttpServletRequest.class.equals(paramTypes[1])) {
                    method.invoke(page, view, request);
                } else if (Map.class.equals(paramTypes[1]) && HttpServletRequest.class.equals(paramTypes[0])) {
        ...
        invokeMethod(after, request, view, page, pageClass);
